 ...
 *  10, 0  => 5
 *  -3, 3  => 0
 *  Number.MAX_VALUE-2, Number.MAX_VALUE => Number.MAX_VALUE-1
...
function getAngleBetweenVectors(x1, y1, x2, y2) {
    var b;
        if(x1 == 1 && y1 == 0 && x2 == 0 && y2 == 1) b = Math.PI/2;
        if(x1 == 0 && y1 == 1 && x2 == 0 && y2 == -1) b = Math.PI;
        if(x1 == 0 && y1 == -1 && x2 == 1 && y2 == 0) b = Math.PI/2;
        if(x1 == 0 && y1 == 1 && x2 == 0 && y2 == 1) b = 0;
        if(x1 == 0 && y1 == 1 && x2 == 1 && y2 == 2) b = 0;
        return b;
}
